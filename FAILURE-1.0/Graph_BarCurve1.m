...
% ----------------------------------------------------------------- 
function fig = Graph_BarCurve1(bins1,freq1,bins2,freq2,...
    ...
    fh3 = plot(x1,y1,'--','Color',MyWine);
    fh4 = plot(x2,y2,'--','Color',MyPurple);
    set(gcf,'color','white');
    ...
    set(fh1,'FaceColor',MyWine);
    set(fh1,'FaceAlpha',0.3);
    set(fh1,'EdgeColor',MyWine);
    set(fh1,'LineStyle','-');
    set(fh2,'FaceColor',MyPurple);
    set(fh2,'FaceAlpha',0.3);
    set(fh2,'EdgeColor',MyPurple);
    set(fh2,'LineStyle','-');
